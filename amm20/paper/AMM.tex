...
\begin{equation}
\begin{split}
P_{\mathrm{buy}}(\Delta_D; D, b) &= \min \Big( \max \big( (1 - \gamma)\tilde{P}, \; \frac{D - \Delta_D}{b} - \alpha \tilde{P} \big), \; (1 + \gamma) \tilde{P} - \epsilon \Big) \\
P_{\mathrm{sell}}(\delta_b; D, b) &= \min \Big( \max \big( (1 - \gamma) \tilde{P} + \epsilon, \; \frac{D}{b - \delta_b} + \alpha \tilde{P} \big), \; (1 + \gamma)\tilde{P} \Big)
\end{split}
\end{equation}
