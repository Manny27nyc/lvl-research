...
\begin{equation}
\begin{split}
P_{\mathrm{buy}}(\Delta_D; D, b) &= \max \big\{ \frac{D - \Delta_D}{b} - \alpha \tilde{P}, \; (1 - \gamma)\tilde{P} \big\} \\
P_{\mathrm{sell}}(\delta_b; D, b) &= \min \big\{ \frac{D}{b - \delta_b} + \alpha \tilde{P}, \; (1 + \gamma)\tilde{P} \big\}
\end{split}
\end{equation}
